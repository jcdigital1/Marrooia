...
export const ChatBackground: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <div className="relative w-full h-full flex flex-col flex-1 min-h-0 bg-[#E8E2D8] overflow-hidden">
      {/* Rich warm base gradient - eliminates the washed out / pale look */}
      <div 
        className="absolute inset-0 pointer-events-none"
        style={{
          background: 'radial-gradient(circle at 50% 20%, #F3EEE7 0%, #E8E1D6 45%, #DCD4C7 100%)',
        }}
      />

      {/* High-detail crisp vector wallpaper pattern (Paint rollers, houses, commercial buildings, solar panels, brushes, ladders, tools) */}
      <div className="absolute inset-0 pointer-events-none opacity-[0.20] mix-blend-multiply">
        <svg
        ...
        >
          <defs>
            <pattern
              id="marroooia-rich-wallpaper"
              width="240"
              height="240"
              patternUnits="userSpaceOnUse"
            >
              {/* === 1. PAINT ROLLER WITH TEXTURE & HANDLE (x: 25, y: 20) === */}
              <g stroke="#3D3023" strokeWidth="1.3" fill="none" strokeLinecap="round" strokeLinejoin="round">
                {/* Cylinder */}
                <rect x="25" y="16" width="34" height="15" rx="3" fill="#3D3023" fillOpacity="0.05" />
                ...
                <rect x="34" y="67" width="8" height="18" rx="2" fill="#3D3023" fillOpacity="0.08" />
              ...
              <g stroke="#3D3023" strokeWidth="1.3" fill="none" strokeLinecap="round" strokeLinejoin="round">
                ...
                {/* House Body */}
                <rect x="131" y="36" width="34" height="24" rx="1" fill="#3D3023" fillOpacity="0.05" />
                {/* Door */}
                <path d="M143 60 v-13 h10 v13" />
                <circle cx="150" cy="53" r="0.7" fill="#3D3023" />
                {/* Window with 4 panes */}
              ...
              <g stroke="#3D3023" strokeWidth="1.3" fill="none" strokeLinecap="round" strokeLinejoin="round">
                {/* Radiant Sun */}
                <circle cx="168" cy="94" r="6" fill="#3D3023" fillOpacity="0.1" />
                ...
                <polygon points="126,128 162,116 172,142 134,154" fill="#3D3023" fillOpacity="0.06" />
                {/* Grid Cells */}
              ...
              <g stroke="#3D3023" strokeWidth="1.3" fill="none" strokeLinecap="round" strokeLinejoin="round">
                ...
                {/* Rim */}
                <ellipse cx="43" cy="120" rx="15" ry="4" fill="#3D3023" fillOpacity="0.08" />
                {/* Bucket Body */}
                <path d="M29 120 L34 148 H52 L57 120" fill="#3D3023" fillOpacity="0.05" />
                {/* Splash Drip */}
                <path d="M38 123 v12 c0 2.5 3 2.5 3 0 v-12" />
                <circle cx="48" cy="140" r="1.2" fill="#3D3023" />
              </g>
              ...
              <g stroke="#3D3023" strokeWidth="1.3" fill="none" strokeLinecap="round" strokeLinejoin="round">
                ...
                {/* Metal Ferrule */}
                <polygon points="75,195 86,184 94,191 83,202" fill="#3D3023" fillOpacity="0.1" />
                <line x1="78" y1="192" x2="89" y2="181" strokeDasharray="1 1.5" />
                {/* Bristles */}
                <polygon points="86,184 99,171 107,178 94,191" fill="#3D3023" fillOpacity="0.05" />
              ...
              <g stroke="#3D3023" strokeWidth="1.3" fill="none" strokeLinecap="round" strokeLinejoin="round">
                ...
                <circle cx="198" cy="153" r="1.5" fill="#3D3023" />
                {/* Building Tower */}
                <rect x="185" y="168" width="26" height="56" rx="1.5" fill="#3D3023" fillOpacity="0.05" />
                {/* Window Grid */}
              ...
              <g stroke="#3D3023" strokeWidth="1.3" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path d="M17 192 L33 192 L29 208 L21 208 Z" fill="#3D3023" fillOpacity="0.06" />
                <rect x="23" y="208" width="4" height="15" rx="1" fill="#3D3023" fillOpacity="0.1" />
                <circle cx="25" cy="219" r="0.7" fill="#3D3023" />
              </g>

              {/* === 9. ARTIST PALETTE WITH COLOR WELLS (x: 185, y: 75) === */}
              <g stroke="#3D3023" strokeWidth="1.3" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path d="M185 82 C185 72, 212 72, 212 85 C212 94, 203 98, 198 94 C195 91, 190 92, 190 96 C190 102, 185 96, 185 82 Z" fill="#3D3023" fillOpacity="0.05" />
                <circle cx="192" cy="79" r="1.5" fill="#3D3023" />
                <circle cx="200" cy="78" r="1.5" fill="#3D3023" />
                <circle cx="206" cy="85" r="1.5" fill="#3D3023" />
                <circle cx="192" cy="88" r="1.8" />
              </g>

              {/* === 10. SPARKLES & CRAFT ACCENTS (Dynamic Fillers) === */}
              {/* Star 1 */}
              <path d="M82 22 L84 27 L89 29 L84 31 L82 36 L80 31 L75 29 L80 27 Z" fill="#3D3023" fillOpacity="0.3" stroke="none" />
              {/* Star 2 */}
              <path d="M158 74 L159.5 78 L163.5 79.5 L159.5 81 L158 85 L156.5 81 L152.5 79.5 L156.5 78 Z" fill="#3D3023" fillOpacity="0.25" stroke="none" />
              {/* Star 3 */}
              <path d="M222 32 L223.5 35 L227 36.5 L223.5 38 L222 41 L220.5 38 L217 36.5 L220.5 35 Z" fill="#3D3023" fillOpacity="0.25" stroke="none" />
              {/* Star 4 */}
              <path d="M136 182 L137.5 185.5 L141 187 L137.5 188.5 L136 192 L134.5 188.5 L131 187 L134.5 185.5 Z" fill="#3D3023" fillOpacity="0.25" stroke="none" />

              {/* Paint Swatch Wave */}
              <path d="M60 124 C68 120, 74 128, 82 124 C90 120, 96 126, 104 122" stroke="#3D3023" strokeWidth="1.2" strokeLinecap="round" fill="none" strokeDasharray="3 2" />
              
              {/* Droplets & Plus Marks */}
              <circle cx="68" cy="58" r="1.6" fill="#3D3023" fillOpacity="0.3" />
              <circle cx="112" cy="18" r="1.4" fill="#3D3023" fillOpacity="0.25" />
              <circle cx="216" cy="120" r="1.5" fill="#3D3023" fillOpacity="0.25" />
              <circle cx="150" cy="226" r="1.3" fill="#3D3023" fillOpacity="0.2" />

              {/* Alignment Plus crosses */}
              <g stroke="#3D3023" strokeWidth="1" strokeLinecap="round" strokeOpacity="0.3">
          ...
          <rect width="100%" height="100%" fill="url(#marroooia-rich-wallpaper)" />
        </svg>
      </div>
      ...
      <div 
        className="absolute inset-0 pointer-events-none"
        style={{
          background: 'radial-gradient(circle at 50% 50%, transparent 65%, rgba(60, 45, 30, 0.06) 100%)',
        }}
      />
